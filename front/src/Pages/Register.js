...
import { ValidacionR } from '../helpers/ValidacionR.js';
import { registroUsuario } from '../Redux/ActionsUser.js';
    ...
    const [errors, setErrors] = React.useState({});
      ...
      async function registrarUsuario() {
        try {
          ...
          await dispatch( registroUsuario(usuarioCrear) )
